...
A collection of R/RStudio basics, data wrangling, modeling, and plotting compiled from course notes.

- 📄 **View/Download the PDF:** [View/Download the PDF](./r-reference-card.pdf)
